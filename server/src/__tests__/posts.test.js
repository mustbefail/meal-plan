...
describe('creating post', () => {
  test('will all parameters should succeed', async () => {
    const post = {
...
describe('listing posts', () => {
  ...
  test('should return posts sorted by creation date descending by default', async () => {
    const posts = await listAllPosts()
    const sortedSamplePosts = createdSamplePosts.toSorted((a, b) => b.createdAt - a.createdAt)
    expect(posts.map((post) => post.createdAt)).toEqual(sortedSamplePosts.map((post) => post.createdAt))
  })
  test('should take into account provided sorting options', async () => {
    const posts = await listAllPosts({ sortBy: 'updateAt', sortOrder: 'ascending' })
    const sortedSamplePosts = createdSamplePosts.toSorted((a, b) => a.updatedAt - b.updatedAt)
